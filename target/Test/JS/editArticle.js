...
// ————————————————————————————————————————————————————————————————————————————————————————
//Ajax传递参数
function submitVal(partition, category, articleTitleVal, articleContentVal, label) {
    $.ajax({
        type: 'POST',
        url: '/WritingServlet',
        data: {
        ...
        error: function () {//XX失败
            console.log("发表文章出现异常，请重试！ ERROR");
            alert("发表文章出现异常，请重试！");
        }
    });
}
...
$("#editArticle_publish").on({
    click: function () {
        ...
        if (bool) {
            // 传递参数给$.AJAX()
            submitVal(obtainVal().paritition, obtainVal().category,
